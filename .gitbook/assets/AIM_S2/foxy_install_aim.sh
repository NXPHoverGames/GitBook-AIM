...
sudo apt-get install -y python3-argcomplete python3-empy python3-jinja2 python3-cerberus python3-coverage python3-matplotlib python3-numpy python3-packaging python3-pkgconfig python3-opencv python3-colcon-common-extensions python3-wheel python3-setuptools python3-request python3-serial python3-six python3-toml python3-psutil python3-jinja2 python3-opencv python3-pysolar
